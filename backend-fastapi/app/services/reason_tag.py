...
def generate_reason_tags(
    ...
    tags: list[str] = []
    scaled_protein = food.protein * amount_ratio
    scaled_carbs = food.carbs * amount_ratio
    scaled_fat = food.fat * amount_ratio
    ...
    # 식이섬유
    fiber = (food.dietary_fiber or 0) * amount_ratio
    if fiber > 5:
        tags.append("식이섬유 풍부")
