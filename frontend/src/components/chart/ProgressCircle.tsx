...
export function ProgressCircle({ consumed, goal, percentage }: ProgressCircleProps) {
  const safeGoal = goal > 0 ? goal : 1;
  const calculatedPercentage = percentage ?? Math.round((consumed / safeGoal) * 100);
    ...
    <div className="flex flex-col items-center">
      <div className="relative h-44 w-44" style={{ minHeight: "176px", minWidth: "176px" }}>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <p className="bg-gradient-to-br from-gray-900 to-gray-700 bg-clip-text text-3xl font-bold text-transparent">
            {consumed}
          </p>
